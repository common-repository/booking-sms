<?php
/*
Plugin Name: Booking Calendar - Clockwork SMS
Plugin URI: http://wordpress.org/extend/plugins/booking-sms/
Description: Receive SMS notifications for bookings, send out reminder text messages.
Version: 1.1.3
Author: Mediaburst
...
$GLOBALS['clockwork_plugins'][ basename( dirname( __FILE__ ) ) ] = '1.2.1';
